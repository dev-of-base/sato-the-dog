...
export default function Navbar() {
  ...
  const menuItems = [
    ...
    { href: "#gallery", label: "Gallery", target: "_self" },
    { href: "#sato-store", label: "Merch Store", target: "_self" },
    { href: "#sato-nft-collection", label: "NFTs", target: "_self" },
    { href: "#base-arena", label: "Base Arena", target: "_self" },
